// fish Haven - ADD the key and change units to imperial
const apiURL = "//api.openweathermap.org/data/2.5/weather?id=5585000&appid=79ecb9ae3225480c66f41a9ccbe4878b&units=imperial";
...
// 5 days weather
const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5585000&appid=79ecb9ae3225480c66f41a9ccbe4878b&units=imperial";
fetch(forecastURL)
  .then((response) => response.json())
  .then((forecastObject) => {
